...
import { Bot, UserCheck, Calendar, RefreshCw, Sparkles } from "lucide-react";
...
const AgentsModulesSection = () => {
  const agents = [
    ...
    },
    {
      icon: RefreshCw,
      type: "Módulo de Automação",
      title: "Módulo de Follow-Up (FUP) Personalizado",
      subtitle: "",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {agents.map((agent, index) => (
            <Card key={index} className={`shadow-card border-0 bg-gradient-to-br ${agent.gradient} hover:shadow-lg transition-all duration-300`}>
